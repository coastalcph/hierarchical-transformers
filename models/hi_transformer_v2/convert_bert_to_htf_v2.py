...
from models.hi_transformer_v2 import HiTransformerV2ForMaskedLM, HiTransformerV2ForSequenceClassification, \
    HiTransformerV2Config, HiTransformerV2Tokenizer
...
htf_config = HiTransformerV2Config.from_pretrained('../../data/hi-transformer-v2')
...
htf_model = HiTransformerV2ForMaskedLM.from_config(htf_config)
...
# save tokenizer
htf_tokenizer = HiTransformerV2Tokenizer.from_pretrained('roberta-base')
htf_tokenizer._tokenizer = tokenizer
htf_tokenizer.save_pretrained('../../data/PLMs/hi-transformer-v2-roberta')

# re-load model
htf_model = HiTransformerV2ForSequenceClassification.from_pretrained('../../data/PLMs/hi-transformer-v2-roberta')
print()
