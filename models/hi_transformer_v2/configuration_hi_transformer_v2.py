...
""" Hi-Transformer V2 configuration"""
...
HI_TRANSFORMER_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "hi-transformer-base-v2": "https://huggingface.co/hi-transformer-v2-base/resolve/main/config.json",
    "hi-transformer-large-v2": "https://huggingface.co/hi-transformer-v2-large/resolve/main/config.json",
}


class HiTransformerV2Config(PretrainedConfig):
    r"""
...
class HiTransformerV2OnnxConfig(OnnxConfig):
    @property
