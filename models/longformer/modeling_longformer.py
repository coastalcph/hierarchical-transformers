...
class LongformerSelfAttention(nn.Module):
    ...
    def _sliding_chunks_query_key_matmul(self, query: torch.Tensor, key: torch.Tensor, window_overlap: int):
        ...
        diagonal_chunked_attention_scores = torch.matmul(query, key.transpose(2, 3).clone())
    ...
    def _sliding_chunks_matmul_attn_probs_value(
        ...
        context = torch.matmul(chunked_attn_probs, chunked_value)
    ...
    def _concat_with_global_key_attn_probs(
        ...
        attn_probs_from_global_key = torch.matmul(query_vectors.transpose(1, 2).clone(),
                                                  key_vectors_only_global.permute((0, 2, 3, 1)).clone()).transpose(1, 2)
